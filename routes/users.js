...
usersRouter.get('/dead_list', (req, res) => userDeadListController.process(req, res));
usersRouter.get('/detail/:id', (req, res) => userDetailController.process(req, res));
usersRouter.get('/dead_detail/:id', (req, res) => userDeadDetailController.process(req, res));
usersRouter.delete('/delete/:id', (req, res) => userDeleteController.process(req, res));
